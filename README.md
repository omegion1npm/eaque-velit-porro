# @omegion1npm/eaque-velit-porro

[![NPM Package Version](https://img.shields.io/npm/v/@omegion1npm/eaque-velit-porro)](https://www.npmjs.com/package/@omegion1npm/eaque-velit-porro)
[![Build Status](https://github.com/omegion1npm/eaque-velit-porro/workflows/CI/badge.svg)](https://github.com/omegion1npm/eaque-velit-porro/actions?query=workflow%3ACI)
...
```
npm i @omegion1npm/eaque-velit-porro
```
...
const SonicBoom = require('@omegion1npm/eaque-velit-porro')
...
* `retryEAGAIN(err, writeBufferLen, remainingBufferLen)`: a function that will be called when @omegion1npm/eaque-velit-porro
    write/writeSync/flushSync encounters a EAGAIN or EBUSY error. If the return value is
    true @omegion1npm/eaque-velit-porro will retry the operation, otherwise it will bubble the
    error. `err` is the error that caused this function to be called,
    `writeBufferLen` is the length of the buffer @omegion1npm/eaque-velit-porro tried to write, and
    `remainingBufferLen` is the length of the remaining buffer @omegion1npm/eaque-velit-porro didn't try to write.
